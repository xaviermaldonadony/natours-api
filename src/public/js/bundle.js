...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieGF2aWVybWFsZG9uYWRvbnkiLCJhIjoiY2ttN2QxMjFtMGs2MDJwczl5dHFyZjR3OSJ9.-8r-q505TaEEkX80NDqvHw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bootom'
    }).setLngLat(loc.coordinates).addTo(map); // adds it to the map var defined previously
    // Add popup
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); // inside the body and right afte the begining
